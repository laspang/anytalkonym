...
if (empty($_SESSION["userid"])) {
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query(array("response"=>$_POST['g-recaptcha-response'], "secret"=>$set_recaptchakey)));
        ...
        if ($resonse['success']=="true") {//config handline
            ...
            if ($db_handle) {
                ...
                $uid=$_SESSION['userid'];
                //ping is not require for single user thery cannot ping anyone.
                // //startping
                // $prefix = "@";
                ...
                $query = "INSERT INTO \"content\" (question, time, uid, uname, touid) VALUES ('$question', '$time', '$uid','$uname','$touid'); ";
